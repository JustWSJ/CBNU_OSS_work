...
Weapon weapons[WEAPON_COUNT] = {
    {"Steel Sword", {0, 10, 2, 0}, 1},
    {"Iron Axe", {0, 12, 1, 0}, 1},
    {"Elven Bow", {0, 8, 5, 0}, 1},
    {"Magic Staff", {5, 0, 0, 10}, 1},
    {"Dagger", {0, 6, 8, 0}, 1}
};

// 방어구 데이터
Armor armors[ARMOR_COUNT] = {
    {"Iron Shield", {10, 0, 0, 0}, 1},
    {"Steel Armor", {20, 0, 0, 0}, 1},
    {"Leather Boots", {0, 0, 5, 0}, 1},
    {"Mage Robe", {5, 0, 0, 10}, 1},
    {"Helm of Insight", {5, 0, 0, 5}, 1}
};
